...
namespace teste
{
    public partial class Form1 : Form
    {
        ...
        public Form1(CadastroForm cadastroForm)
        {
            InitializeComponent();
            this.cadastroForm = cadastroForm;
            this.StartPosition = FormStartPosition.Manual;
            this.Location = new Point(350, 700);
        ...
        public Form1()
        {
            ...
            InitializeComponent();
            this.StartPosition = FormStartPosition.Manual;
            this.Location = new Point(300, 700);
        ...
        private void Alfabeto(object sender, EventArgs e)
        {
            ...
            bool capsLockAtivado = Console.CapsLock;


            bool shiftOuCapsLockAtivado = capsLockAtivado || chkCapsLock.Checked || chkShiftL.Checked || chkShiftR.Checked;


            if (shiftOuCapsLockAtivado)
            {
                cadastroForm.ReceiveKeyInput(key.ToUpper());
            ...
            {
                cadastroForm.ReceiveKeyInput(key.ToLower());
